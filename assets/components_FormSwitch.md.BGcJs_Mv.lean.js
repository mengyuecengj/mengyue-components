import{_ as i}from"./chunks/switch.vue_vue_type_script_setup_true_lang.pBvfvEUd.js";import{z as A,I as B,o as P,c as M,ah as x,J as t,w as n,j as a,a as d,y as s}from"./chunks/framework.DmoDkOge.js";import"./chunks/useClassComputed.Wc7vThmZ.js";import"./chunks/useStyleComputed.CS9pThfp.js";const D={style:{display:"flex","flex-direction":"column",gap:"15px","align-items":"flex-start"}},C={style:{display:"flex",gap:"20px"}},N=JSON.parse('{"title":"Switch","description":"","frontmatter":{},"headers":[],"relativePath":"components/FormSwitch.md","filePath":"components/FormSwitch.md"}'),Y={name:"components/FormSwitch.md"},X=Object.assign(Y,{setup(T){const r=s(!0),p=s(!0),h=s(!1),u=s(!1),m=s(!1),k=s(!0),b=s(!1),g=s(!0),c=s(!1),v=s(!0),V=s(!1),y=s(!0),f=s(!0),S=s(!0),w=s(!1),z=s(!0);return A([r,p,h,u,m,k,b,g,c,v,V,y,f,S,w,z],()=>{orceUpdate()}),(U,e)=>{const o=B("ShowCode");return P(),M("div",null,[e[13]||(e[13]=x("",5)),t(o,{title:"代码演示",code:`
<template>
