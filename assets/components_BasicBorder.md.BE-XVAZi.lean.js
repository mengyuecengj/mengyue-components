...
<template>
  ...
  `.trim()},{demo:r(()=>[i(e,{rounded:"",topColor:"red",bottomColor:"blue",leftColor:"green",rightColor:"yellow",width:"300px",height:"100px",textColor:"#ff00ff",paddingText:"100px",colorBackground:"#2c2",boxShadow:"10px 2px 8px red"},{default:r(()=>[...d[20]||(d[20]=[t(" 组合使用 ",-1)])]),_:1})]),_:1},8,["code"]),d[45]||(d[45]=l("",7))])}}});export{C as __pageData,f as default};
