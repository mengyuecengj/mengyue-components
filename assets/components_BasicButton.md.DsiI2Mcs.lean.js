import{_ as n}from"./chunks/button.vue_vue_type_script_setup_true_lang.CBzuurEY.js";import{_ as r}from"./chunks/a.vue_vue_type_script_setup_true_lang.CTwejrid.js";import{_ as u}from"./chunks/plus.vue_vue_type_script_setup_true_lang.itubdvu-.js";import{I as o,c as k,o as h,ah as p,J as s,j as l,w as i,a}from"./chunks/framework.D3tsReks.js";import"./chunks/useClassComputed.XPUKWacB.js";import"./chunks/useColorUtils.1y1X9QiZ.js";import"./chunks/useStyleComputed.BZuPLADM.js";import"./chunks/IconBase.vue_vue_type_script_setup_true_lang.D13zBShk.js";const g={style:{display:"grid","grid-template-columns":"repeat(auto-fit, minmax(200px, 1fr))",gap:"10px","justify-content":"center","margin-top":"20px"}},m={style:{display:"flex",gap:"50px"}},B={style:{display:"flex",gap:"50px"}},y={style:{display:"flex",gap:"50px"}},b={style:{display:"grid","grid-template-columns":"repeat(auto-fit, minmax(200px, 1fr))",gap:"10px","justify-content":"center","margin-top":"20px"}},c=JSON.parse('{"title":"Button","description":"","frontmatter":{},"headers":[],"relativePath":"components/BasicButton.md","filePath":"components/BasicButton.md"}'),f={name:"components/BasicButton.md"},S=Object.assign(f,{setup(M){return(Y,t)=>{const e=o("ClientOnly"),d=o("ShowCode");return h(),k("div",null,[t[37]||(t[37]=p("",6)),s(d,{title:"代码演示",code:`
<template>
