import{_ as h,a as e}from"./chunks/step.vue_vue_type_script_setup_true_lang.Drf7GC24.js";import{I as b,o,c as u,a8 as k,J as s,w as t,j as a,a as n,G as z,H as m,b as f,A as g}from"./chunks/framework.DvHWw5tv.js";const x={style:{"margin-top":"20px",display:"flex",gap:"10px"}},S=["disabled"],B=["disabled"],M=JSON.parse('{"title":"Steps","description":"","frontmatter":{},"headers":[],"relativePath":"plus/NavigationStep.md","filePath":"plus/NavigationStep.md"}'),A={name:"plus/NavigationStep.md"},Y=Object.assign(A,{setup(v){const p=g(0),l=g([{index:0,title:"第一步",description:"填写基本信息"},{index:1,title:"第二步",description:"上传相关文件"},{index:2,title:"第三步",description:"确认提交"},{index:3,title:"第四步",description:"完成"}]),c=()=>{p.value>0&&p.value--},y=()=>{p.value<l.value.length-1&&p.value++};return(D,i)=>{const d=b("ShowCode");return o(),u("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1775839268000"},[i[8]||(i[8]=k("",6)),s(d,{title:"代码演示",code:`
<template>
  <MYSteps :active='1'>
