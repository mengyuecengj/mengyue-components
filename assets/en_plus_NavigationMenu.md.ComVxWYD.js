import{_ as r,a as n,b as d}from"./chunks/menusubMenu.vue_vue_type_script_setup_true_lang.CN53R8Fy.js";import{I as o,o as h,c as k,a8 as p,J as s,w as t,j as a,a as i}from"./chunks/framework.DvHWw5tv.js";const u={style:{width:"240px",background:"#2f3b46","border-radius":"6px",padding:"8px 0"}},m={style:{background:"#2f3b46","border-radius":"6px"}},g={style:{width:"240px","border-radius":"6px",overflow:"hidden"}},M={style:{width:"240px",background:"#2f3b46","border-radius":"6px",padding:"8px 0"}},b={style:{background:"#2f3b46","border-radius":"6px"}},D=JSON.parse('{"title":"Menu","description":"","frontmatter":{},"headers":[],"relativePath":"en/plus/NavigationMenu.md","filePath":"en/plus/NavigationMenu.md"}'),y={name:"en/plus/NavigationMenu.md"},Y=Object.assign(y,{setup(f){return(x,e)=>{const l=o("ShowCode");return h(),k("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776104037000"},[e[42]||(e[42]=p('<h1 id="menu" tabindex="-1">Menu <a class="header-anchor" href="#menu" aria-label="Permalink to “Menu”">​</a></h1><h2 id="brief-introduction" tabindex="-1">Brief Introduction <a class="header-anchor" href="#brief-introduction" aria-label="Permalink to “Brief Introduction”">​</a></h2><p>The Menu navigation component provides sidebar and top navigation functionality. <code>mengyue-components</code> has encapsulated it and performed <code>vitest</code> testing. You can use <code>&lt;MYMenu&gt;&lt;/MYMenu&gt;</code> or <code>&lt;MYMenu /&gt;</code> to implement a navigation menu component.</p><h2 id="basic-usage" tabindex="-1">Basic Usage <a class="header-anchor" href="#basic-usage" aria-label="Permalink to “Basic Usage”">​</a></h2><h3 id="vertical-menu" tabindex="-1">Vertical Menu <a class="header-anchor" href="#vertical-menu" aria-label="Permalink to “Vertical Menu”">​</a></h3><p>Default vertical menu, supports multi-level nesting.</p>',6)),s(l,{title:"Code Demo",code:`
<template>
