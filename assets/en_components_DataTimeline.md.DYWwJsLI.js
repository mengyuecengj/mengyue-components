import{_ as o,a as n}from"./chunks/timelineItem.vue_vue_type_script_setup_true_lang.Dvzc4bCH.js";import{I as d,o as p,c as m,a8 as r,J as s,w as i,j as e,a}from"./chunks/framework.DvHWw5tv.js";const h={style:{margin:"20px 0"}},c={style:{margin:"20px 0"}},g={style:{margin:"20px 0"}},y={style:{margin:"20px 0"}},T=JSON.parse('{"title":"Timeline","description":"","frontmatter":{},"headers":[],"relativePath":"en/components/DataTimeline.md","filePath":"en/components/DataTimeline.md"}'),u={name:"en/components/DataTimeline.md"},x=Object.assign(u,{setup(k){return(f,t)=>{const l=d("ShowCode");return p(),m("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776410922000"},[t[18]||(t[18]=r('<h1 id="timeline" tabindex="-1">Timeline <a class="header-anchor" href="#timeline" aria-label="Permalink to “Timeline”">​</a></h1><h2 id="brief-introduction" tabindex="-1">Brief Introduction <a class="header-anchor" href="#brief-introduction" aria-label="Permalink to “Brief Introduction”">​</a></h2><p>The <code>Timeline</code> component is used to display a chronological sequence of events. You can use <code>&lt;MYTimeline&gt;&lt;/MYTimeline&gt;</code> and <code>&lt;MYTimelineItem&gt;&lt;/MYTimelineItem&gt;</code> to implement a timeline component.</p><h2 id="basic-timeline" tabindex="-1">Basic Timeline <a class="header-anchor" href="#basic-timeline" aria-label="Permalink to “Basic Timeline”">​</a></h2>',4)),s(l,{title:"Basic Timeline",description:"Vertical timeline, default direction is vertical",code:`<template>
  <MYTimeline>
