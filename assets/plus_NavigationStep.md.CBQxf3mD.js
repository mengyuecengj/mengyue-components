import{_ as d,a}from"./chunks/step.vue_vue_type_script_setup_true_lang.Drf7GC24.js";import{I as y,o as k,c as o,a8 as c,J as s,w as i,j as e,a as n,G as m,H as S,b as B,A as g}from"./chunks/framework.DvHWw5tv.js";const f={style:{"margin-top":"20px",display:"flex",gap:"10px"}},A=["disabled"],D=["disabled"],_=JSON.parse('{"title":"Steps","description":"","frontmatter":{},"headers":[],"relativePath":"plus/NavigationStep.md","filePath":"plus/NavigationStep.md"}'),v={name:"plus/NavigationStep.md"},P=Object.assign(v,{setup(x){const l=g(0),r=g([{index:0,title:"第一步",description:"填写基本信息"},{index:1,title:"第二步",description:"上传相关文件"},{index:2,title:"第三步",description:"确认提交"},{index:3,title:"第四步",description:"完成"}]),u=()=>{l.value>0&&l.value--},b=()=>{l.value<r.value.length-1&&l.value++};return(C,t)=>{const p=y("ShowCode");return k(),o("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776410922000"},[t[8]||(t[8]=c('<h1 id="steps" tabindex="-1">Steps <a class="header-anchor" href="#steps" aria-label="Permalink to “Steps”">​</a></h1><h2 id="简易介绍" tabindex="-1">简易介绍 <a class="header-anchor" href="#简易介绍" aria-label="Permalink to “简易介绍”">​</a></h2><p>Steps 步骤条组件，用于引导用户按照流程完成任务。mengyue-components 进行了封装并进行了 vitest 测试。 可以使用 <code>&lt;MYSteps&gt;&lt;/MYSteps&gt;</code> 和 <code>&lt;MYStep&gt;&lt;/MYStep&gt;</code> 组合来实现步骤条功能。</p><h2 id="基本用法" tabindex="-1">基本用法 <a class="header-anchor" href="#基本用法" aria-label="Permalink to “基本用法”">​</a></h2><h3 id="基础步骤条" tabindex="-1">基础步骤条 <a class="header-anchor" href="#基础步骤条" aria-label="Permalink to “基础步骤条”">​</a></h3><p>默认的水平步骤条，显示当前进度状态。</p>',6)),s(p,{title:"代码演示",code:`
<template>
  <MYSteps :active='1'>
