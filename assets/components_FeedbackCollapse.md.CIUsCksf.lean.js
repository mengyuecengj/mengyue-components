import{d as g,h as C,c as k,o as u,r as c,W as _,N as f,j as s,a1 as A,a as m,t as M,a2 as Y,x as h,I as P,ah as v,J as l,w as i}from"./chunks/framework.D3tsReks.js";const B={class:"my-collapse"},b=g({name:"MYCollapse",__name:"collapse",props:{modelValue:{},accordion:{type:Boolean}},emits:["update:modelValue","change"],setup(r,{emit:d}){const t=r,o=d,a=C({get(){return t.modelValue},set(e){o("update:modelValue",e),o("change",e)}});return _("collapse",{activeNames:a,toggleItem(e){if(t.accordion)a.value=a.value===e?"":e;else{const n=Array.isArray(a.value)?a.value:[];n.includes(e)?a.value=n.filter(y=>y!==e):a.value=[...n,e]}}}),(e,n)=>(u(),k("div",B,[c(e.$slots,"default")]))}}),D={class:"my-collapse-item"},V=["aria-expanded"],x={class:"my-collapse-item__content"},p=g({name:"MYCollapse-item",__name:"collapseItem",props:{name:{},title:{}},setup(r){const d=r,t=f("collapse"),o=C(()=>Array.isArray(t.activeNames.value)?t.activeNames.value.includes(d.name):t.activeNames.value===d.name),a=()=>{t.toggleItem(d.name)};return(e,n)=>(u(),k("div",D,[s("div",{class:"my-collapse-item__header","aria-expanded":o.value,onClick:a},[c(e.$slots,"title",{},()=>[m(M(r.title),1)])],8,V),A(s("div",x,[c(e.$slots,"default")],512),[[Y,o.value]])]))}}),S=JSON.parse('{"title":"Collapse","description":"","frontmatter":{},"headers":[],"relativePath":"components/FeedbackCollapse.md","filePath":"components/FeedbackCollapse.md"}'),N={name:"components/FeedbackCollapse.md"},T=Object.assign(N,{setup(r){const d=h(["1"]),t=h("a");return h(["1"]),h(["1"]),h(["1"]),(o,a)=>{const e=P("ShowCode");return u(),k("div",null,[a[8]||(a[8]=v("",5)),l(e,{title:"代码演示",code:`
<template>
