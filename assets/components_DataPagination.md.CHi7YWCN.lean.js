import{_ as h}from"./chunks/pagination.vue_vue_type_script_setup_true_lang.KM4sAvfc.js";import{I as g,o as c,c as y,ah as k,J as a,w as o,j as t,a as m,y as e}from"./chunks/framework.DmoDkOge.js";const b={style:{margin:"20px 0"}},u={style:{margin:"20px 0"}},v=JSON.parse('{"title":"Pagination","description":"","frontmatter":{},"headers":[],"relativePath":"components/DataPagination.md","filePath":"components/DataPagination.md"}'),B={name:"components/DataPagination.md"},P=Object.assign(B,{setup(A){const n=e(1),l=e(10),d=e(5),r=e(10);return(D,s)=>{const p=g("ShowCode");return c(),y("div",null,[s[4]||(s[4]=k("",4)),a(p,{title:"基础分页器",code:`
<template>
  <MYPagination 
