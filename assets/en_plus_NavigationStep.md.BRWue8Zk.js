import{_ as r,a}from"./chunks/step.vue_vue_type_script_setup_true_lang.Drf7GC24.js";import{I as b,o as h,c as k,a8 as c,J as s,w as i,j as e,a as n,G as y,H as S,b as f,A as u}from"./chunks/framework.DvHWw5tv.js";const D={style:{"margin-top":"20px",display:"flex",gap:"10px"}},C=["disabled"],B=["disabled"],M=JSON.parse('{"title":"Steps","description":"","frontmatter":{},"headers":[],"relativePath":"en/plus/NavigationStep.md","filePath":"en/plus/NavigationStep.md"}'),A={name:"en/plus/NavigationStep.md"},_=Object.assign(A,{setup(v){const p=u(0),d=u([{index:0,title:"Step 1",description:"Fill in basic information"},{index:1,title:"Step 2",description:"Upload relevant files"},{index:2,title:"Step 3",description:"Confirm submission"},{index:3,title:"Step 4",description:"Complete"}]),g=()=>{p.value>0&&p.value--},m=()=>{p.value<d.value.length-1&&p.value++};return(x,t)=>{const l=b("ShowCode");return h(),k("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776104037000"},[t[8]||(t[8]=c('<h1 id="steps" tabindex="-1">Steps <a class="header-anchor" href="#steps" aria-label="Permalink to “Steps”">​</a></h1><h2 id="introduction" tabindex="-1">Introduction <a class="header-anchor" href="#introduction" aria-label="Permalink to “Introduction”">​</a></h2><p>The Steps component is used to guide users through completing tasks in a sequential process. mengyue-components has encapsulated this component and conducted vitest testing. You can use <code>&lt;MYSteps&gt;&lt;/MYSteps&gt;</code> and <code>&lt;MYStep&gt;&lt;/MYStep&gt;</code> together to implement the steps functionality.</p><h2 id="basic-usage" tabindex="-1">Basic Usage <a class="header-anchor" href="#basic-usage" aria-label="Permalink to “Basic Usage”">​</a></h2><h3 id="basic-steps" tabindex="-1">Basic Steps <a class="header-anchor" href="#basic-steps" aria-label="Permalink to “Basic Steps”">​</a></h3><p>Default horizontal steps bar showing current progress status.</p>',6)),s(l,{title:"Code Demo",code:`
<template>
  <MYSteps :active='1'>
