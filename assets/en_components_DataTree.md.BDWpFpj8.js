import{_ as b,a as n}from"./chunks/treeSelect.vue_vue_type_script_setup_true_lang.htKHRB31.js";import{I as f,o as g,c as N,a8 as s,J as d,w as r,j as t,a as o,A as i}from"./chunks/framework.DvHWw5tv.js";import"./chunks/checkbox-group.vue_vue_type_script_setup_true_lang.D38PW01g.js";import"./chunks/useStyleComputed.CediP0a2.js";const k={style:{"max-width":"600px"}},S=JSON.parse('{"title":"Tree","description":"","frontmatter":{},"headers":[],"relativePath":"en/components/DataTree.md","filePath":"en/components/DataTree.md"}'),C={name:"en/components/DataTree.md"},w=Object.assign(C,{setup(v){const c=i(null),h=i([]),m=i([2,4]),p=i(null),u=i(null);return(x,e)=>{const a=f("ShowCode");return g(),N("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776410922000"},[e[6]||(e[6]=s('<h1 id="tree" tabindex="-1">Tree <a class="header-anchor" href="#tree" aria-label="Permalink to “Tree”">​</a></h1><h2 id="brief-introduction" tabindex="-1">Brief Introduction <a class="header-anchor" href="#brief-introduction" aria-label="Permalink to “Brief Introduction”">​</a></h2><p>The Tree component is used to display hierarchical data structures, supporting expand/collapse, selection, checkbox, and other features. It can be used for organizational charts, file directories, categories, and similar scenarios.</p><h2 id="basic-usage" tabindex="-1">Basic Usage <a class="header-anchor" href="#basic-usage" aria-label="Permalink to “Basic Usage”">​</a></h2><p>Basic tree structure display with node click event support.</p>',5)),d(a,{title:"Basic Usage",code:`
<template>
  <MYTree
    :data='treeData'
...
<\/script>
`},{demo:r(()=>[d(n,{modelValue:c.value,"onUpdate:modelValue":e[1]||(e[1]=l=>c.value=l),data:[{id:1,name:"Root Node 1",children:[{id:2,name:"Child Node 1-1"},{id:3,name:"Child Node 1-2",children:[{id:4,name:"Grandchild Node 1"},{id:5,name:"Grandchild Node 2"}]}]},{id:6,name:"Root Node 2",children:[{id:7,name:"Child Node 2-1"}]}],props:{label:"name",value:"id",children:"children"},placeholder:"Please select",clearable:"",style:{width:"240px"}},null,8,["modelValue"])]),_:1}),e[10]||(e[10]=t("h3",{id:"multiple-selection-mode",tabindex:"-1"},[o("Multiple Selection Mode "),t("a",{class:"header-anchor",href:"#multiple-selection-mode","aria-label":"Permalink to “Multiple Selection Mode”"},"​")],-1)),d(a,{title:"Multiple Selection Mode",code:`
<template>
  <MYTreeSelect
...
<\/script>
`},{demo:r(()=>[d(n,{modelValue:p.value,"onUpdate:modelValue":e[4]||(e[4]=l=>p.value=l),data:[{id:1,name:"Root Node 1",children:[{id:2,name:"Child Node 1-1"},{id:3,name:"Child Node 1-2",children:[{id:4,name:"Grandchild Node 1"},{id:5,name:"Grandchild Node 2"}]}]}],props:{label:"name",value:"id",children:"children"},filterable:"",placeholder:"Enter keyword",style:{width:"240px"}},null,8,["modelValue"])]),_:1}),e[15]||(e[15]=t("h2",{id:"custom-styling",tabindex:"-1"},[o("Custom Styling "),t("a",{class:"header-anchor",href:"#custom-styling","aria-label":"Permalink to “Custom Styling”"},"​")],-1)),e[16]||(e[16]=t("p",null,"Supports custom text color, background color, and active color.",-1)),d(a,{title:"Custom Styling",code:`
<template>
  <MYTreeSelect 
    v-model='styledValue'
    :data='treeData'
