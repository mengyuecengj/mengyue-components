import{_ as l}from"./chunks/result.vue_vue_type_script_setup_true_lang.BToKtu14.js";import{_ as r}from"./chunks/button.vue_vue_type_script_setup_true_lang.DRTmpM5H.js";import{I as d,o as p,c as h,a8 as o,J as e,w as i,j as s,a}from"./chunks/framework.DvHWw5tv.js";import"./chunks/useClassComputed.B59PvPGn.js";import"./chunks/useColorUtils.Cv3Q488p.js";const c={style:{display:"flex","flex-direction":"column",gap:"20px"}},u={style:{display:"flex",gap:"10px","justify-content":"center"}},k={style:{display:"flex",gap:"10px","justify-content":"center"}},C=JSON.parse('{"title":"Result","description":"","frontmatter":{},"headers":[],"relativePath":"en/plus/FeedbackResult.md","filePath":"en/plus/FeedbackResult.md"}'),m={name:"en/plus/FeedbackResult.md"},A=Object.assign(m,{setup(y){return(b,t)=>{const n=d("ShowCode");return p(),h("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776104037000"},[t[6]||(t[6]=o('<h1 id="result" tabindex="-1">Result <a class="header-anchor" href="#result" aria-label="Permalink to “Result”">​</a></h1><h2 id="brief-introduction" tabindex="-1">Brief Introduction <a class="header-anchor" href="#brief-introduction" aria-label="Permalink to “Brief Introduction”">​</a></h2><p>The Result component is used to display the status of an operation result.<br> You can use <code>&lt;MYResult&gt;&lt;/MYResult&gt;</code> to display a result.</p><h2 id="basic-usage" tabindex="-1">Basic Usage <a class="header-anchor" href="#basic-usage" aria-label="Permalink to “Basic Usage”">​</a></h2><p>Use the <code>title</code> prop to set the main title and the <code>subTitle</code> prop to set the subtitle.</p>',5)),e(n,{title:"Code Demo",code:`
<template>
