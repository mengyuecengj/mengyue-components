import{_ as e}from"./chunks/button.vue_vue_type_script_setup_true_lang.BZH5oCUC.js";import{m as l}from"./chunks/messageManager.CS5syews.js";import{I as F,o as P,c as H,ah as k,J as n,w as t,j as a,a as i,y as S}from"./chunks/framework.DmoDkOge.js";import"./chunks/useClassComputed.Wc7vThmZ.js";import"./chunks/useColorUtils.Cc58FlZ9.js";const L={style:{display:"flex",gap:"10px","flex-wrap":"wrap"}},I={style:{display:"flex",gap:"10px","flex-wrap":"wrap"}},O={style:{display:"flex",gap:"10px","flex-wrap":"wrap"}},V={style:{display:"flex",gap:"10px","flex-wrap":"wrap"}},N={style:{display:"flex",gap:"10px","flex-wrap":"wrap"}},X=JSON.parse('{"title":"Message","description":"","frontmatter":{},"headers":[],"relativePath":"components/FeedbackMessage.md","filePath":"components/FeedbackMessage.md"}'),R={name:"components/FeedbackMessage.md"},$=Object.assign(R,{setup(W){const h=S(null),r=()=>{l.info("这是一条信息提示"),console.log("显示信息提示")},d=()=>{l.success("操作成功！"),console.log("显示成功提示")},o=()=>{l.warning("请注意操作风险"),console.log("显示警告提示")},g=()=>{l.error("操作失败，请重试"),console.log("显示错误提示")},y=()=>{l({content:"这条消息可以手动关闭",type:"info",showClose:!0}),console.log("显示带关闭按钮的消息")},c=()=>{l({content:"这条消息只显示1秒",type:"success",duration:1e3}),console.log("显示短时间消息")},B=()=>{l({content:"这条消息显示10秒",type:"warning",duration:1e4}),console.log("显示长时间消息")},A=()=>{l({content:"这条消息不会自动关闭",type:"info",duration:0,showClose:!0}),console.log("显示永久消息")},u=()=>{l({content:"左上角消息",position:"top-left"}),console.log("显示左上角消息")},b=()=>{l({content:"右上角消息",position:"top-right"}),console.log("显示右上角消息")},D=()=>{l({content:"顶部居中消息",position:"top-center"}),console.log("显示顶部居中消息")},m=()=>{l({content:"左下角消息",position:"bottom-left"}),console.log("显示左下角消息")},f=()=>{l({content:"右下角消息",position:"bottom-right"}),console.log("显示右下角消息")},C=()=>{l({content:"底部居中消息",position:"bottom-center"}),console.log("显示底部居中消息")},M=()=>{l({content:'<strong>加粗文本</strong> 和 <span style="color: red;">红色文本</span>',dangerouslyUseHTMLString:!0}),console.log("显示HTML内容消息")},w=()=>{h.value=l({content:"这条消息需要通过按钮关闭",type:"info",duration:0}),console.log("显示手动关闭消息")},x=()=>{h.value&&(h.value.close(),h.value=null),console.log("手动关闭消息")},E=()=>{l({content:"关闭时会触发回调",type:"success",onClose:()=>{console.log("消息已关闭")}}),console.log("显示带回调的消息")},Y=()=>{l({content:"这条消息有自定义偏移量",type:"info",offset:100}),console.log("显示带偏移量的消息")},v=()=>{l({content:"消息1",offset:20}),l({content:"消息2",offset:80}),l({content:"消息3",offset:140}),console.log("显示多个偏移消息")},T=()=>{l({content:"组合使用示例消息",type:"success",duration:5e3,showClose:!0,position:"top-center",offset:50,zIndex:1e4,onClose:()=>{console.log("组合消息已关闭")}}),console.log("显示组合使用消息")};return(z,s)=>{const p=F("ShowCode");return P(),H("div",null,[s[21]||(s[21]=k("",5)),n(p,{title:"代码演示",code:`
<template>
...
<template>
  ...
  `.trim()},{demo:t(()=>[a("div",I,[n(e,{onClick:c},{default:t(()=>[...s[5]||(s[5]=[i("短时间 (1秒)",-1)])]),_:1}),n(e,{onClick:B},{default:t(()=>[...s[6]||(s[6]=[i("长时间 (10秒)",-1)])]),_:1}),n(e,{onClick:A},{default:t(()=>[...s[7]||(s[7]=[i("永久显示",-1)])]),_:1})])]),_:1},8,["code"]),s[26]||(s[26]=a("h2",{id:"自定义位置",tabindex:"-1"},[i("自定义位置 "),a("a",{class:"header-anchor",href:"#自定义位置","aria-label":"Permalink to “自定义位置”"},"​")],-1)),s[27]||(s[27]=a("p",null,[i("使用"),a("code",null,"position"),i("属性可以设置消息显示的位置。")],-1)),n(p,{title:"代码演示",code:`
<template>
    <div style='display: flex; gap: 10px; flex-wrap: wrap;'>
