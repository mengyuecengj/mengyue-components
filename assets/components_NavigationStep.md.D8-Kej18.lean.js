import{d as A,x as S,ak as M,y as Y,p as P,c as o,o as d,n as v,r as x,W as N,N as w,h as y,j as i,e as f,G as m,a as e,t as B,I as E,ah as C,J as s,w as n,H as T,b as F}from"./chunks/framework.BWIYv-lY.js";const b=A({name:"MYSteps",__name:"steps",props:{active:{type:Number,default:0},finishStatus:{type:String,default:"finish"},direction:{type:String,default:"horizontal"},align:{type:String,default:"left"},stepCount:Number},setup(k,{expose:p}){const a=k,r=S(0),h=M({active:a.active,finishStatus:a.finishStatus,direction:a.direction,stepCount:r.value});return Y(()=>{h.active=a.active,h.finishStatus=a.finishStatus,h.direction=a.direction,h.stepCount=r.value}),P(()=>{const u=document.querySelectorAll(".my-step");r.value=u.length}),N("stepsContext",h),p({stepCount:r}),(u,t)=>(d(),o("div",{class:v(["my-steps",[`my-steps--${k.direction}`,`my-steps--align-${k.align}`]])},[x(u.$slots,"default")],2))}}),$={class:"my-step__icon-container"},V={class:"my-step__icon"},I={class:"my-step__content-wrapper"},z={class:"my-step__content"},j={class:"my-step__title"},q={key:0,class:"my-step__description"},l=A({name:"MYStep",__name:"step",props:{title:{type:String,required:!0},description:{type:String,default:""},status:{type:String,default:""},index:{type:Number,required:!0}},setup(k,{expose:p}){const a=k,r=w("stepsContext"),h=y(()=>r?.active??0),u=y(()=>r?.finishStatus??"finish"),t=y(()=>r?.direction??"horizontal"),g=y(()=>r?.stepCount??0),c=y(()=>a.status?a.status:a.index<h.value?u.value:a.index===h.value?"process":"wait"),D=y(()=>a.index===g.value-1);return p({currentStatus:c}),(_,G)=>(d(),o("div",{class:v(["my-step",[`my-step--${t.value}`,`my-step--status-${c.value}`]])},[i("div",$,[i("div",V,[x(_.$slots,"icon",{},()=>[c.value==="finish"?(d(),o(m,{key:0},[e("✔️")],64)):c.value==="error"?(d(),o(m,{key:1},[e("❌")],64)):c.value==="process"?(d(),o(m,{key:2},[e("🔵")],64)):(d(),o(m,{key:3},[e("⚪")],64))])])]),i("div",I,[i("div",z,[i("div",j,B(k.title),1),k.description?(d(),o("div",q,B(k.description),1)):f("",!0)])]),D.value?f("",!0):(d(),o("div",{key:0,class:v(["my-step__line",`my-step__line--${t.value}`])},null,2))],2))}}),J={style:{"margin-top":"20px",display:"flex",gap:"10px"}},L=["disabled"],O=["disabled"],W=JSON.parse('{"title":"Steps","description":"","frontmatter":{},"headers":[],"relativePath":"components/NavigationStep.md","filePath":"components/NavigationStep.md"}'),R={name:"components/NavigationStep.md"},K=Object.assign(R,{setup(k){const p=S(0),a=S([{index:0,title:"第一步",description:"填写基本信息"},{index:1,title:"第二步",description:"上传相关文件"},{index:2,title:"第三步",description:"确认提交"},{index:3,title:"第四步",description:"完成"}]),r=()=>{p.value>0&&p.value--},h=()=>{p.value<a.value.length-1&&p.value++};return(u,t)=>{const g=E("ShowCode");return d(),o("div",null,[t[8]||(t[8]=C("",6)),s(g,{title:"代码演示",code:`
<template>
  <MYSteps :active='1'>
