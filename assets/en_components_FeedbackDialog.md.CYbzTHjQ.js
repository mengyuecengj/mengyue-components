import{_ as d}from"./chunks/dialog.vue_vue_type_script_setup_true_lang.BRVMNYI2.js";import{_ as o}from"./chunks/button.vue_vue_type_script_setup_true_lang.DRTmpM5H.js";import{I as w,o as D,c as v,a8 as B,J as a,w as l,a as t,j as s,G as x,H as A,t as E,A as r}from"./chunks/framework.DvHWw5tv.js";import"./chunks/useStyleComputed.CediP0a2.js";import"./chunks/useClassComputed.B59PvPGn.js";import"./chunks/useColorUtils.Cv3Q488p.js";const M={style:{height:"600px"}},Y={style:{display:"flex","justify-content":"space-between"}},S={style:{display:"flex",gap:"10px","justify-content":"flex-end"}},N=JSON.parse('{"title":"Dialog","description":"","frontmatter":{},"headers":[],"relativePath":"en/components/FeedbackDialog.md","filePath":"en/components/FeedbackDialog.md"}'),T={name:"en/components/FeedbackDialog.md"},H=Object.assign(T,{setup(V){const k=r(!1),g=r(!1),u=r(!1),m=r(!1),y=r(!1),b=r(!1),p=r(!1),c=r(!1),h=r(!1),f=()=>{console.log("Dialog opened")},C=()=>{console.log("Dialog closed")};return(O,e)=>{const n=w("ShowCode");return D(),v("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776410922000"},[e[49]||(e[49]=B('<h1 id="dialog" tabindex="-1">Dialog <a class="header-anchor" href="#dialog" aria-label="Permalink to “Dialog”">​</a></h1><h2 id="brief-introduction" tabindex="-1">Brief Introduction <a class="header-anchor" href="#brief-introduction" aria-label="Permalink to “Brief Introduction”">​</a></h2><p>The <code>dialog</code> component is used to display modal dialogs on a page.<br> You can use <code>&lt;MYDialog&gt;&lt;/MYDialog&gt;</code> or <code>&lt;MYDialog /&gt;</code> to implement a dialog.</p><h2 id="basic-usage" tabindex="-1">Basic Usage <a class="header-anchor" href="#basic-usage" aria-label="Permalink to “Basic Usage”">​</a></h2><p>Use <code>v-model</code> to control the visibility of the dialog.</p>',5)),a(n,{title:"Code Demo",code:`
<template>
...
<template>
  ...
  `.trim()},{demo:l(()=>[a(o,{type:"primary",onClick:e[18]||(e[18]=i=>h.value=!0)},{default:l(()=>[...e[44]||(e[44]=[t("Combined Usage",-1)])]),_:1}),a(d,{modelValue:h.value,"onUpdate:modelValue":e[21]||(e[21]=i=>h.value=i),title:"Combined Usage Example",width:"500px",height:"350px",backgroundColor:"#fff",borderColor:"#8d4dd1",textColor:"#333",closeOnClickModal:!1,closeOnPressEscape:!0,overflow:!1,onOpen:f,onClose:C},{footer:l(()=>[s("div",S,[a(o,{type:"info",onClick:e[19]||(e[19]=i=>h.value=!1)},{default:l(()=>[...e[45]||(e[45]=[t("Cancel",-1)])]),_:1}),a(o,{type:"primary",onClick:e[20]||(e[20]=i=>h.value=!1)},{default:l(()=>[...e[46]||(e[46]=[t("Confirm",-1)])]),_:1})])]),default:l(()=>[e[47]||(e[47]=s("p",{style:{color:"black"}},"This is a complete example of combined usage",-1)),e[48]||(e[48]=s("p",{style:{color:"black"}},"It includes all available properties and features",-1))]),_:1},8,["modelValue"])]),_:1},8,["code"]),e[66]||(e[66]=B(`<h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to “API Reference”">​</a></h2><h3 id="props" tabindex="-1">Props <a class="header-anchor" href="#props" aria-label="Permalink to “Props”">​</a></h3><table tabindex="0"><thead><tr><th>Parameter</th><th>Description</th><th>Type</th><th>Options</th><th>Default</th></tr></thead><tbody><tr><td>modelValue</td><td>Whether to show the dialog</td><td>boolean</td><td>—</td><td><code>false</code></td></tr><tr><td>title</td><td>Dialog title</td><td>string</td><td>—</td><td><code>&#39;&#39;</code></td></tr><tr><td>width</td><td>Dialog width</td><td>string | number</td><td>—</td><td><code>400</code></td></tr><tr><td>height</td><td>Dialog height</td><td>string | number</td><td>—</td><td><code>200</code></td></tr><tr><td>closeOnClickModal</td><td>Close on overlay click</td><td>boolean</td><td>—</td><td><code>true</code></td></tr><tr><td>closeOnPressEscape</td><td>Close on ESC key press</td><td>boolean</td><td>—</td><td><code>true</code></td></tr><tr><td>backgroundColor</td><td>Background color</td><td>string</td><td>—</td><td><code>&#39;&#39;</code></td></tr><tr><td>borderColor</td><td>Border color</td><td>string</td><td>—</td><td><code>&#39;&#39;</code></td></tr><tr><td>textColor</td><td>Text color</td><td>string</td><td>—</td><td><code>&#39;&#39;</code></td></tr><tr><td>overflow</td><td>Overflow control</td><td>boolean</td><td>—</td><td><code>false</code></td></tr></tbody></table><h3 id="events" tabindex="-1">Events <a class="header-anchor" href="#events" aria-label="Permalink to “Events”">​</a></h3><table tabindex="0"><thead><tr><th>Event Name</th><th>Description</th><th>Parameters</th></tr></thead><tbody><tr><td>update:modelValue</td><td>Dialog visibility state update</td><td><code>value: boolean</code></td></tr><tr><td>open</td><td>Triggered when dialog opens</td><td>—</td></tr><tr><td>close</td><td>Triggered when dialog closes</td><td>—</td></tr></tbody></table><h3 id="slots" tabindex="-1">Slots <a class="header-anchor" href="#slots" aria-label="Permalink to “Slots”">​</a></h3><table tabindex="0"><thead><tr><th>Name</th><th>Description</th></tr></thead><tbody><tr><td>default</td><td>Dialog body content</td></tr><tr><td>header</td><td>Custom header</td></tr><tr><td>footer</td><td>Custom footer</td></tr></tbody></table><h3 id="type-definitions" tabindex="-1">Type Definitions <a class="header-anchor" href="#type-definitions" aria-label="Permalink to “Type Definitions”">​</a></h3><div class="language-typescript line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676;">interface</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994;"> DialogProps</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> {</span></span>
