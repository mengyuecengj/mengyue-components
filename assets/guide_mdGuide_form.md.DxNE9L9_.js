import{p as k,ag as F,C as l,c as V,o as x,af as m,G as n,w as e,a as p}from"./chunks/framework.Dg2MLihl.js";const R=JSON.parse('{"title":"Form","description":"","frontmatter":{},"headers":[],"relativePath":"guide/mdGuide/form.md","filePath":"guide/mdGuide/form.md"}'),C={name:"guide/mdGuide/form.md"},S=Object.assign(C,{setup(y){const r=k(),s=F({username:"",enabled:!1,gender:"1",hobbies:[]}),b={username:[{required:!0,message:"用户名不能为空"}],gender:[{required:!0,message:"请选择性别"}],hobbies:[{required:!0,message:"请选择至少一个兴趣爱好"}]};function g(){var o;s.username="",s.enabled=!1,s.gender="",s.hobbies=[],(o=r.value)==null||o.clearValidate()}function f(o){alert(o?"验证通过，可以提交！":"验证失败，请检查表单！")}function h(){r.value.validate().then(()=>{alert(`提交成功！
`+JSON.stringify(s,null,2))}).catch(()=>{alert("提交失败，请检查输入项！")})}return(o,a)=>{const q=l("MYInput"),d=l("MYForm-item"),u=l("MYButton"),_=l("MYSwitch"),c=l("MYRadio"),M=l("MYRadio-group"),i=l("MYCheckbox"),Y=l("MYCheckbox-group"),v=l("MYForm");return x(),V("div",null,[a[12]||(a[12]=m(`<h1 id="form" tabindex="-1">Form <a class="header-anchor" href="#form" aria-label="Permalink to &quot;Form&quot;">​</a></h1><h2 id="简易介绍" tabindex="-1">简易介绍 <a class="header-anchor" href="#简易介绍" aria-label="Permalink to &quot;简易介绍&quot;">​</a></h2><p>form表单组件，用于收集用户输入的数据并进行校验。mengyue-components进行了封装并进行了vitest测试。<br> form表单的实现标签有两种<code>&lt;MYForm&gt;&lt;/MYForm&gt;</code>或者<code>&lt;MYForm /&gt;</code>和<code>&lt;MYForm-item&gt;&lt;/MYForm-item&gt;</code>或者<code>&lt;MYForm-item /&gt;</code>。来实现表单</p><h2 id="表单使用" tabindex="-1">表单使用 <a class="header-anchor" href="#表单使用" aria-label="Permalink to &quot;表单使用&quot;">​</a></h2><p>例如在这里实现个带有常规表单组件的组合表单示例</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki nord" style="color:#d8dee9ff;" tabindex="0"><code><span class="line"><span>&lt;MYForm ref=&quot;formRef&quot; v-model=&quot;formData&quot; :rules=&quot;rules&quot; @validate=&quot;onValidate&quot; style=&quot; color: red&quot;&gt;</span></span>
