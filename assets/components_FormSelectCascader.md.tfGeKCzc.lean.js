import{_ as n}from"./chunks/selectCascader.vue_vue_type_script_setup_true_lang.D-luTlR3.js";import{I as A,o as B,c as V,ah as b,J as i,w as d,j as a,a as e,y as p}from"./chunks/framework.DmoDkOge.js";import"./chunks/useStyleComputed.CS9pThfp.js";const D={style:{position:"relative","z-index":"1000"}},x={style:{position:"relative","z-index":"1000"}},C={style:{position:"relative","z-index":"1000"}},f={style:{position:"relative","z-index":"1000"}},P={style:{position:"relative","z-index":"1000"}},S={style:{position:"relative","z-index":"1000"}},Y=JSON.parse('{"title":"SelectCascader","description":"","frontmatter":{},"headers":[],"relativePath":"components/FormSelectCascader.md","filePath":"components/FormSelectCascader.md"}'),_={name:"components/FormSelectCascader.md"},I=Object.assign(_,{setup(E){const r=p(""),h=p(""),k=p(""),c=p(""),u=p(""),m=p(""),g=[{value:"option1",label:"选项1"},{value:"option2",label:"选项2"},{value:"option3",label:"选项3"},{value:"option4",label:"选项4"}],y=[{value:"option1",label:"选项1"},{value:"option2",label:"选项2"}],v=[{value:"option1",label:"选项1"},{value:"option2",label:"选项2",disabled:!0}],o=[{value:"group1",label:"分组1",children:[{value:"option1-1",label:"选项1-1"},{value:"option1-2",label:"选项1-2"}]},{value:"group2",label:"分组2",children:[{value:"option2-1",label:"选项2-1"},{value:"option2-2",label:"选项2-2",children:[{value:"option2-2-1",label:"选项2-2-1"},{value:"option2-2-2",label:"选项2-2-2"}]}]}];return(F,s)=>{const t=A("ShowCode");return B(),V("div",null,[s[6]||(s[6]=b("",5)),i(t,{title:"代码演示",code:`
<template>
...
<template>
  ...
  `.trim()},{demo:d(()=>[a("div",f,[i(n,{modelValue:c.value,"onUpdate:modelValue":s[3]||(s[3]=l=>c.value=l),options:o,placeholder:"多级菜单"},null,8,["modelValue"])])]),_:1},8,["code"]),s[14]||(s[14]=a("h2",{id:"自定义尺寸",tabindex:"-1"},[e("自定义尺寸 "),a("a",{class:"header-anchor",href:"#自定义尺寸","aria-label":"Permalink to “自定义尺寸”"},"​")],-1)),s[15]||(s[15]=a("p",null,[e("使用"),a("code",null,"width"),e("和"),a("code",null,"height"),e("属性可以自定义选择器的宽度和高度。")],-1)),i(t,{title:"代码演示",code:`
<template>
