import{_ as l}from"./chunks/card.vue_vue_type_script_setup_true_lang.GQXtmW_h.js";import{I as o,o as p,c as n,ah as r,J as d,w as i,j as t,a}from"./chunks/framework.DmoDkOge.js";import"./chunks/useStyleComputed.CS9pThfp.js";const h={style:{"max-width":"400px"}},x={style:{display:"flex",gap:"20px","flex-wrap":"wrap"}},f={style:{display:"flex",gap:"20px","flex-wrap":"wrap"}},g={style:{display:"flex",gap:"20px","flex-wrap":"wrap"}},y={style:{"max-width":"400px"}},b={style:{display:"flex",gap:"20px","flex-wrap":"wrap"}},C=JSON.parse('{"title":"Card","description":"","frontmatter":{},"headers":[],"relativePath":"components/OtherCard.md","filePath":"components/OtherCard.md"}'),m={name:"components/OtherCard.md"},M=Object.assign(m,{setup(k){return(v,e)=>{const s=o("ShowCode");return p(),n("div",null,[e[25]||(e[25]=r('<h1 id="card" tabindex="-1">Card <a class="header-anchor" href="#card" aria-label="Permalink to “Card”">​</a></h1><h2 id="简易介绍" tabindex="-1">简易介绍 <a class="header-anchor" href="#简易介绍" aria-label="Permalink to “简易介绍”">​</a></h2><p>Card 卡片组件，用于展示信息和内容块，支持自定义头部、主体和底部。mengyue-components 进行了封装并进行了 vitest 测试。 可以使用 <code>&lt;MYCard&gt;&lt;/MYCard&gt;</code> 或者 <code>&lt;MYCard /&gt;</code> 来实现卡片布局。</p><h2 id="基本用法" tabindex="-1">基本用法 <a class="header-anchor" href="#基本用法" aria-label="Permalink to “基本用法”">​</a></h2><h3 id="基础卡片" tabindex="-1">基础卡片 <a class="header-anchor" href="#基础卡片" aria-label="Permalink to “基础卡片”">​</a></h3><p>基础的卡片组件，包含头部、主体和底部。</p>',6)),d(s,{title:"代码演示",code:`
<template>
  <MYCard>
    <template #header>
