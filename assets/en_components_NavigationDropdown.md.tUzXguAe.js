import{_ as a,M as d}from"./chunks/dropdownItem.BzRBRONv.js";import{I as r,o as p,c as m,a8 as l,J as i,w as e,a as s,j as n}from"./chunks/framework.DvHWw5tv.js";import"./chunks/useClassComputed.B59PvPGn.js";const h={style:{display:"flex",gap:"10px","align-items":"center"}},w=JSON.parse('{"title":"Dropdown","description":"","frontmatter":{},"headers":[],"relativePath":"en/components/NavigationDropdown.md","filePath":"en/components/NavigationDropdown.md"}'),k={name:"en/components/NavigationDropdown.md"},y=Object.assign(k,{setup(g){return(u,t)=>{const o=r("ShowCode");return p(),m("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776104037000"},[t[35]||(t[35]=l('<h1 id="dropdown" tabindex="-1">Dropdown <a class="header-anchor" href="#dropdown" aria-label="Permalink to “Dropdown”">​</a></h1><h2 id="brief-introduction" tabindex="-1">Brief Introduction <a class="header-anchor" href="#brief-introduction" aria-label="Permalink to “Brief Introduction”">​</a></h2><p>The Dropdown component is used to display a set of actions or menu items. mengyue-components has encapsulated it and performed vitest testing. You can use <code>&lt;MYDropdown&gt;&lt;/MYDropdown&gt;</code> or <code>&lt;MYDropdown /&gt;</code> to implement a dropdown menu component.</p><h2 id="basic-usage" tabindex="-1">Basic Usage <a class="header-anchor" href="#basic-usage" aria-label="Permalink to “Basic Usage”">​</a></h2><h3 id="basic-dropdown-menu" tabindex="-1">Basic Dropdown Menu <a class="header-anchor" href="#basic-dropdown-menu" aria-label="Permalink to “Basic Dropdown Menu”">​</a></h3><p>Default dropdown menu with hover trigger.</p>',6)),i(o,{title:"Code Demo",code:`
<template>
  <MYDropdown>
    <template #default>
      Dropdown Menu
