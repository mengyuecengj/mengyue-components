...
<\/script>`},{demo:y(()=>[l("div",Ys,[p(T,{columns:u.value,data:j.value},{pagination:y(()=>[p(ms,{"current-page":C.value,"onUpdate:currentPage":n[1]||(n[1]=g=>C.value=g),"page-size":v.value,"onUpdate:pageSize":n[2]||(n[2]=g=>v.value=g),total:E.value.length,layout:"prev, pager, next",onChange:w},null,8,["current-page","page-size","total"])]),_:1},8,["columns","data"])])]),_:1}),n[10]||(n[10]=hs("",9))])}}});export{Is as __pageData,js as default};
