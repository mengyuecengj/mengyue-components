import{d as M,z as D,o as v,c as B,O as N,k as V,n as S,j as a,t as Y,J as s,T as z,w as o,b as $,r as C,e as I,y as c,R,W as U,h as f,N as j,a as t,I as q,ah as x}from"./chunks/framework.BzrxsKI0.js";import{_ as H}from"./chunks/scrollbar.vue_vue_type_script_setup_true_lang.BPKNNw4Z.js";import{w as J}from"./chunks/withInstall.BiBM9XaQ.js";import{u as L}from"./chunks/useStyleComputed.BVjmiXVX.js";import"./chunks/useClassComputed.DNrZSa4y.js";import"./chunks/useScrollCommon.BexzubNp.js";const W=J(H),G={modelValue:{type:[String,Number],default:""},placeholder:{type:String,default:"请选择"},disabled:{type:Boolean,default:!1},width:{type:[String,Number],default:"260px"},height:{type:[String,Number],default:"40px"},backgroundColor:{type:String,default:""},hoverbackgroundColor:{type:String,default:""},borderColor:{type:String,default:""},autoScrollbar:{type:Boolean,default:!0}},K={class:"selected-value"},Q={key:1,class:"select-dropdown-content"},y=M({name:"MYSelect",__name:"select",props:G,emits:["update:modelValue"],setup(u,{emit:k}){const l=u,m=k,p=c(null),b=c(!1),h=c(!1),e=c(!1),r=c(""),d=()=>{R(()=>{if(!l.autoScrollbar){b.value=!1;return}if(p.value){const g=(p.value.querySelector(".select-dropdown-content")||p.value).scrollHeight;b.value=g>190}})},_=(i,g)=>{l.disabled||(m("update:modelValue",i),r.value=g||String(i),h.value=!1)},w=()=>{l.disabled||(e.value=!0)},F=()=>{e.value=!1,h.value=!1},O=()=>{l.disabled||(h.value=!h.value,h.value&&(d(),A()))},P=L(l,{propToStyleMap:{width:"width",height:"height",backgroundColor:"backgroundColor",hoverbackgroundColor:"--hover-bg-color"}}),A=()=>{const i=l.modelValue;if(i==null||i===""){r.value="";return}if(p.value){const g=p.value.querySelectorAll("[data-value]"),E=Array.from(g).find(T=>T.dataset.value===String(i));r.value=E?.dataset.label||""}};return D(()=>l.modelValue,i=>{A()},{immediate:!0}),D(h,i=>{i&&d()}),U("select",{selectOption:_,currentValue:f(()=>l.modelValue),disabled:f(()=>l.disabled),width:f(()=>l.width),height:f(()=>l.height)}),(i,g)=>(v(),B("div",{class:S(["select-e",{"is-disabled":i.disabled,"is-focused":e.value}]),tabindex:"0",style:N(V(P)),onFocus:w,onBlur:F},[a("div",{class:"select-trigger",onClick:O},[a("span",K,Y(r.value||i.placeholder),1),a("span",{class:S(["arrow-icon",{"is-open":h.value}])},[...g[0]||(g[0]=[a("svg",{viewBox:"0 0 24 24",width:"16",height:"16"},[a("path",{d:"M7 10l5 5 5-5z"})],-1)])],2)]),s(z,{name:"slide-fade"},{default:o(()=>[h.value?(v(),B("div",{key:0,ref_key:"dropdownRef",ref:p,class:"select-dropdown"},[b.value?(v(),$(V(W),{key:0,height:"200px",thumbColor:"#4C4D4F",thumbHoverColor:"#2a2a2e",trackColor:"#2a2a2e"},{default:o(()=>[C(i.$slots,"default")]),_:3})):(v(),B("div",Q,[C(i.$slots,"default")]))],512)):I("",!0)]),_:3})],38))}}),X=["data-value","data-label"],n=M({name:"MYOption",__name:"option",props:{value:{type:[String,Number],required:!0},label:{type:String,default:""},disabled:{type:Boolean,default:!1}},setup(u){const k=u,l=j("select");if(!l)throw new Error("MYOption must be used inside MYSelect");const{selectOption:m,currentValue:p,disabled:b}=l,h=f(()=>p.value===k.value),e=()=>{!k.disabled&&!b.value&&m(k.value,k.label||String(k.value))};return(r,d)=>(v(),B("div",{class:S(["select-option",{"is-selected":h.value,"is-disabled":u.disabled}]),"data-value":u.value,"data-label":u.label||u.value,onClick:e},[C(r.$slots,"default",{},()=>[t(Y(u.label),1)])],10,X))}}),Z={style:{position:"relative","z-index":"1000"}},ee={style:{position:"relative","z-index":"1000"}},ae={style:{position:"relative","z-index":"1000"}},se={style:{position:"relative","z-index":"1000"}},le={style:{position:"relative","z-index":"1000"}},he=JSON.parse('{"title":"Select","description":"","frontmatter":{},"headers":[],"relativePath":"components/FormSelect.md","filePath":"components/FormSelect.md"}'),te={name:"components/FormSelect.md"},ke=Object.assign(te,{setup(u){const k=c(""),l=c(""),m=c(""),p=c(""),b=c("B");return(h,e)=>{const r=q("ShowCode");return v(),B("div",null,[e[5]||(e[5]=x("",5)),s(r,{title:"代码演示",code:`
<template>
