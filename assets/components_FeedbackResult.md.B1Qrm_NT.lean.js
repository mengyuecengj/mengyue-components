const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/primary.ZED9fjmi.js","assets/chunks/framework.PAn8Jj8p.js","assets/chunks/success.hoi03XYh.js","assets/chunks/warning.BcalW4L0.js","assets/chunks/error.CDRZfxSr.js","assets/chunks/info.BY_s9Lhi.js"])))=>i.map(i=>d[i]);
import{d as f,al as r,a0 as B,c as k,o as h,b as A,j as s,K as x,k as y,t as m,r as b,an as d,I as T,ah as g,J as i,w as e,a}from"./chunks/framework.PAn8Jj8p.js";import{_ as p}from"./chunks/button.vue_vue_type_script_setup_true_lang.v3w7-jGH.js";import"./chunks/useClassComputed.nZJ4II5u.js";import"./chunks/useColorUtils.CfbVybqV.js";const v={class:"result"},D={class:"result-title"},C={class:"result-subtitle"},P={key:1},R={class:"result-extra"},l=f({name:"MYResult",__name:"result",props:{icon:{},title:{},subTitle:{}},setup(o){const c=o,n={primary:r(()=>d(()=>import("./chunks/primary.ZED9fjmi.js"),__vite__mapDeps([0,1]))),success:r(()=>d(()=>import("./chunks/success.hoi03XYh.js"),__vite__mapDeps([2,1]))),warning:r(()=>d(()=>import("./chunks/warning.BcalW4L0.js"),__vite__mapDeps([3,1]))),error:r(()=>d(()=>import("./chunks/error.CDRZfxSr.js"),__vite__mapDeps([4,1]))),info:r(()=>d(()=>import("./chunks/info.BY_s9Lhi.js"),__vite__mapDeps([5,1])))}[c.icon||"info"],_=B();return(u,I)=>(h(),k("div",v,[(h(),A(x(y(n)),{class:"result-icon"})),s("div",D,m(o.title),1),s("div",C,[y(_)["sub-title"]?b(u.$slots,"sub-title",{key:0}):(h(),k("span",P,m(o.subTitle),1))]),s("div",R,[b(u.$slots,"extra")])]))}}),M={style:{display:"flex","flex-direction":"column",gap:"20px"}},Y={style:{display:"flex",gap:"10px","justify-content":"center"}},E={style:{display:"flex",gap:"10px","justify-content":"center"}},N=JSON.parse('{"title":"Result","description":"","frontmatter":{},"headers":[],"relativePath":"components/FeedbackResult.md","filePath":"components/FeedbackResult.md"}'),S={name:"components/FeedbackResult.md"},O=Object.assign(S,{setup(o){return(c,t)=>{const n=T("ShowCode");return h(),k("div",null,[t[6]||(t[6]=g("",5)),i(n,{title:"代码演示",code:`
<template>
