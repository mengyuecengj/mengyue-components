import{_ as p}from"./chunks/radio-button.vue_vue_type_script_setup_true_lang.CDTxzAWp.js";import{a as d,_ as o}from"./chunks/radio-group.vue_vue_type_script_setup_true_lang.Zb_JEi3Z.js";import{y as Y,I as c,o as C,c as V,a8 as B,J as s,w as i,j as e,a as t,A as n,R as x}from"./chunks/framework.DvHWw5tv.js";const P={style:{display:"flex",gap:"20px"}},S={style:{display:"flex","flex-direction":"column",gap:"15px"}},N=JSON.parse('{"title":"Radio","description":"","frontmatter":{},"headers":[],"relativePath":"plus/FormRadio.md","filePath":"plus/FormRadio.md"}'),E={name:"plus/FormRadio.md"},w=Object.assign(E,{setup(F){const h=n("option1"),k=n("2"),u=n("1"),g=n("1"),m=n("1"),f=n("1"),v=n("default"),b=n("1"),y=n("default"),A=n("1"),R=n("1"),D=n("1"),M=()=>{x(()=>{})};return Y([h,k,u,g,m,f,v,b,y,A,R,D],()=>{M()}),(z,a)=>{const r=c("ShowCode");return C(),V("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776410922000"},[a[27]||(a[27]=B("",6)),s(r,{title:"代码演示",code:`
<template>
