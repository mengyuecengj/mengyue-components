import{a as l,_ as r}from"./chunks/checkbox-group.vue_vue_type_script_setup_true_lang.BLKbLKuo.js";import{z as f,I as M,o as Y,c as B,ah as c,J as s,w as i,j as t,a,y as n,R as A}from"./chunks/framework.DmoDkOge.js";const E=JSON.parse('{"title":"Checkbox","description":"","frontmatter":{},"headers":[],"relativePath":"plus/FormCheckbox.md","filePath":"plus/FormCheckbox.md"}'),V={name:"plus/FormCheckbox.md"},F=Object.assign(V,{setup(D){const h=n(!0),p=n(["option1"]),k=n([]),b=n(["red"]),m=n(["mon"]),u=n([]),g=n(["default"]),x=n(["option1"]),C=n(["1"]),y=n(["default"]),v=()=>{A(()=>{})};return f([h,p,k,b,m,u,g,x,C,y],()=>{v()}),(P,e)=>{const o=M("ShowCode");return Y(),B("div",null,[e[18]||(e[18]=c("",6)),s(o,{title:"代码演示",code:`
<template>
