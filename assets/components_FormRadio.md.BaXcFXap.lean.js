import{_ as p}from"./chunks/radio-button.vue_vue_type_script_setup_true_lang.DMHTXmZB.js";import{a as d,_ as o}from"./chunks/radio-group.vue_vue_type_script_setup_true_lang.BaxTmDG1.js";import{z as M,I as Y,o as C,c as V,ah as B,J as s,w as i,j as e,a as t,y as n,R as x}from"./chunks/framework.DmoDkOge.js";const P={style:{display:"flex",gap:"20px"}},S={style:{display:"flex","flex-direction":"column",gap:"15px"}},N=JSON.parse('{"title":"Radio","description":"","frontmatter":{},"headers":[],"relativePath":"components/FormRadio.md","filePath":"components/FormRadio.md"}'),E={name:"components/FormRadio.md"},w=Object.assign(E,{setup(F){const h=n("option1"),k=n("2"),u=n("1"),g=n("1"),m=n("1"),v=n("1"),f=n("default"),b=n("1"),y=n("default"),A=n("1"),R=n("1"),D=n("1"),c=()=>{x(()=>{})};return M([h,k,u,g,m,v,f,b,y,A,R,D],()=>{c()}),(z,a)=>{const r=Y("ShowCode");return C(),V("div",null,[a[27]||(a[27]=B("",6)),s(r,{title:"代码演示",code:`
<template>
