import{_ as n}from"./chunks/input.vue_vue_type_script_setup_true_lang.Qz_sZHj_.js";import{y as f,I as C,o as D,c as V,a8 as x,J as s,w as o,j as t,a,R as w,A as r}from"./chunks/framework.DvHWw5tv.js";import"./chunks/useClassComputed.B59PvPGn.js";import"./chunks/useStyleComputed.CediP0a2.js";const F=JSON.parse('{"title":"Input","description":"","frontmatter":{},"headers":[],"relativePath":"en/plus/FormInput.md","filePath":"en/plus/FormInput.md"}'),B={name:"en/plus/FormInput.md"},E=Object.assign(B,{setup(A){const p=r(""),h=r(""),k=r(""),u=r(""),m=r(""),c=r(""),g=r(""),b=r(""),y=r(""),i=()=>{w(()=>{})};return f([p,h,k,u,m,c,g,b,y],()=>{i()}),(v,e)=>{const d=C("ShowCode");return D(),V("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776410922000"},[e[9]||(e[9]=x('<h1 id="input" tabindex="-1">Input <a class="header-anchor" href="#input" aria-label="Permalink to “Input”">​</a></h1><h2 id="introduction" tabindex="-1">Introduction <a class="header-anchor" href="#introduction" aria-label="Permalink to “Introduction”">​</a></h2><p>The input component is used for users to enter text content. mengyue-components has encapsulated this component and conducted vitest testing. You can use <code>&lt;MYInput&gt;&lt;/MYInput&gt;</code> to implement an input field.</p><h2 id="basic-usage" tabindex="-1">Basic Usage <a class="header-anchor" href="#basic-usage" aria-label="Permalink to “Basic Usage”">​</a></h2><p>Use <code>modelValue</code> to bind the value of the input field.</p>',5)),s(d,{title:"Code Demo",code:`
<template>
  <MYInput v-model='inputValue' placeholder='Please enter content' @update:modelValue='forceUpdate' />
</template>
  `.trim()},{demo:o(()=>[s(n,{modelValue:p.value,"onUpdate:modelValue":[e[0]||(e[0]=l=>p.value=l),i],placeholder:"Please enter content"},null,8,["modelValue"])]),_:1},8,["code"]),e[10]||(e[10]=t("h2",{id:"input-type",tabindex:"-1"},[a("Input Type "),t("a",{class:"header-anchor",href:"#input-type","aria-label":"Permalink to “Input Type”"},"​")],-1)),e[11]||(e[11]=t("p",null,[a("The "),t("code",null,"type"),a(" prop can be used to set the input field type, such as "),t("code",null,"text"),a(", "),t("code",null,"password"),a(", etc.")],-1)),s(d,{title:"Code Demo",code:`
<template>
  <MYInput type='password' placeholder='Please enter password' @update:modelValue='forceUpdate' />
</template>
  `.trim()},{demo:o(()=>[s(n,{type:"password",placeholder:"Please enter password","onUpdate:modelValue":i})]),_:1},8,["code"]),e[12]||(e[12]=t("h2",{id:"size-control",tabindex:"-1"},[a("Size Control "),t("a",{class:"header-anchor",href:"#size-control","aria-label":"Permalink to “Size Control”"},"​")],-1)),e[13]||(e[13]=t("p",null,[a("Use the "),t("code",null,"width"),a(" and "),t("code",null,"height"),a(" props to customize the dimensions of the input field.")],-1)),s(d,{title:"Code Demo",code:`
<template>
  <MYInput width='200px' height='40px' placeholder='Custom size' @update:modelValue='forceUpdate' />
</template>
  `.trim()},{demo:o(()=>[s(n,{width:"200px",height:"40px",placeholder:"Custom size","onUpdate:modelValue":i})]),_:1},8,["code"]),e[14]||(e[14]=t("h2",{id:"state-control",tabindex:"-1"},[a("State Control "),t("a",{class:"header-anchor",href:"#state-control","aria-label":"Permalink to “State Control”"},"​")],-1)),e[15]||(e[15]=t("h3",{id:"disabled",tabindex:"-1"},[a("disabled "),t("a",{class:"header-anchor",href:"#disabled","aria-label":"Permalink to “disabled”"},"​")],-1)),e[16]||(e[16]=t("p",null,"Disable the input field:",-1)),s(d,{title:"Code Demo",code:`
<template>
  <MYInput disabled placeholder='Disabled state' />
</template>
  `.trim()},{demo:o(()=>[s(n,{disabled:"",placeholder:"Disabled state"})]),_:1},8,["code"]),e[17]||(e[17]=t("h3",{id:"clearable",tabindex:"-1"},[a("clearable "),t("a",{class:"header-anchor",href:"#clearable","aria-label":"Permalink to “clearable”"},"​")],-1)),e[18]||(e[18]=t("p",null,"Display a clear button:",-1)),s(d,{title:"Code Demo",code:`
<template>
  <div>
    <MYInput 
...
<\/script>
  `.trim()},{demo:o(()=>[t("div",null,[s(n,{modelValue:k.value,"onUpdate:modelValue":[e[1]||(e[1]=l=>k.value=l),i],clearable:"",placeholder:"Clearable content"},null,8,["modelValue"])])]),_:1},8,["code"]),e[19]||(e[19]=t("h3",{id:"showpassword",tabindex:"-1"},[a("showPassword "),t("a",{class:"header-anchor",href:"#showpassword","aria-label":"Permalink to “showPassword”"},"​")],-1)),e[20]||(e[20]=t("p",null,"Toggle password visibility:",-1)),s(d,{title:"Code Demo",code:`
<template>
  <MYInput 
...
<template>
  ...
  `.trim()},{demo:o(()=>[s(n,{modelValue:u.value,"onUpdate:modelValue":[e[3]||(e[3]=l=>u.value=l),i],maxlength:"10",placeholder:"Max 10 characters"},null,8,["modelValue"])]),_:1},8,["code"]),e[24]||(e[24]=t("h3",{id:"word-limit",tabindex:"-1"},[a("Word Limit "),t("a",{class:"header-anchor",href:"#word-limit","aria-label":"Permalink to “Word Limit”"},"​")],-1)),e[25]||(e[25]=t("p",null,[a("Use "),t("code",null,"wordLimit"),a(" to display character count:")],-1)),s(d,{title:"Code Demo",code:`
<template>
  <div>
    <MYInput 
...
<template>
  ...
  `.trim()},{demo:o(()=>[s(n,{modelValue:c.value,"onUpdate:modelValue":[e[5]||(e[5]=l=>c.value=l),i],textColor:"#ff0000",placeholder:"Red text"},null,8,["modelValue"])]),_:1},8,["code"]),e[29]||(e[29]=t("h3",{id:"placeholdercolor",tabindex:"-1"},[a("placeholderColor "),t("a",{class:"header-anchor",href:"#placeholdercolor","aria-label":"Permalink to “placeholderColor”"},"​")],-1)),e[30]||(e[30]=t("p",null,"Custom placeholder color:",-1)),s(d,{title:"Code Demo",code:`
<template>
  <MYInput 
  ...
  `.trim()},{demo:o(()=>[s(n,{modelValue:g.value,"onUpdate:modelValue":[e[6]||(e[6]=l=>g.value=l),i],placeholderColor:"#409EFF",placeholder:"Blue placeholder"},null,8,["modelValue"])]),_:1},8,["code"]),e[31]||(e[31]=t("h2",{id:"multi-line-text",tabindex:"-1"},[a("Multi-line Text "),t("a",{class:"header-anchor",href:"#multi-line-text","aria-label":"Permalink to “Multi-line Text”"},"​")],-1)),e[32]||(e[32]=t("p",null,[a("Use "),t("code",null,'tag="textarea"'),a(" to implement multi-line text input:")],-1)),s(d,{title:"Code Demo",code:`
<template>
  <MYInput 
  ...
  `.trim()},{demo:o(()=>[s(n,{modelValue:b.value,"onUpdate:modelValue":[e[7]||(e[7]=l=>b.value=l),i],tag:"textarea",width:"300px",height:"100px",placeholder:"Multi-line text input"},null,8,["modelValue"])]),_:1},8,["code"]),e[33]||(e[33]=t("h2",{id:"combined-usage",tabindex:"-1"},[a("Combined Usage "),t("a",{class:"header-anchor",href:"#combined-usage","aria-label":"Permalink to “Combined Usage”"},"​")],-1)),e[34]||(e[34]=t("p",null,"Combine multiple props:",-1)),s(d,{title:"Code Demo",code:`
<template>
  <MYInput 
