import{_ as r,a as l}from"./chunks/collapseItem.vue_vue_type_script_setup_true_lang.CQSlmuQ4.js";import{I as m,o as c,c as b,ah as h,J as e,w as t,j as s,a as n,y as k}from"./chunks/framework.DmoDkOge.js";const f=JSON.parse('{"title":"Collapse","description":"","frontmatter":{},"headers":[],"relativePath":"components/FeedbackCollapse.md","filePath":"components/FeedbackCollapse.md"}'),u={name:"components/FeedbackCollapse.md"},_=Object.assign(u,{setup(g){const d=k(["1"]),p=k("a");return(C,a)=>{const o=m("ShowCode");return c(),b("div",null,[a[8]||(a[8]=h("",5)),e(o,{title:"代码演示",code:`
<template>
