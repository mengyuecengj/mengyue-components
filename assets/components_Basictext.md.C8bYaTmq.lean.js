import{_ as l}from"./chunks/text.vue_vue_type_script_setup_true_lang.BJj58skJ.js";import{_ as h,a as n}from"./chunks/col.vue_vue_type_script_setup_true_lang.CxbtjmDJ.js";import{I as r,o as m,c as k,ah as p,J as t,w as s,a as i,j as a}from"./chunks/framework.DmoDkOge.js";import"./chunks/useClassComputed.Wc7vThmZ.js";import"./chunks/useStyleComputed.CS9pThfp.js";import"./chunks/useOverallComputed.c_Wm4sLX.js";const x={style:{display:"flex",gap:"20px"}},u={style:{display:"flex","flex-direction":"column",gap:"10px"}},g={style:{display:"flex","flex-direction":"column",gap:"10px"}},A=JSON.parse('{"title":"Text","description":"","frontmatter":{},"headers":[],"relativePath":"components/Basictext.md","filePath":"components/Basictext.md"}'),f={name:"components/Basictext.md"},P=Object.assign(f,{setup(y){return(b,e)=>{const o=r("MYBorder"),d=r("ShowCode");return m(),k("div",null,[e[16]||(e[16]=p("",6)),t(d,{title:"代码演示",code:`
<template>
...
<template>
  ...
  `.trim()},{demo:s(()=>[t(l,{size:"5em",textColor:"blue"},{default:s(()=>[...e[15]||(e[15]=[i("组合使用medium和blue",-1)])]),_:1})]),_:1},8,["code"]),e[26]||(e[26]=p("",5))])}}});export{A as __pageData,P as default};
