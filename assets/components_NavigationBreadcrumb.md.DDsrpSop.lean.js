import{d as D,o as l,c as o,r as g,e as m,W as P,h as f,N as _,b as M,w as e,K as A,k as y,G as S,a as r,t as v,ai as T,I as x,ah as Y,J as t,j as B}from"./chunks/framework.BzrxsKI0.js";const N={class:"my-breadcrumb","aria-label":"Breadcrumb"},C=D({name:"MYBreadcrumb",__name:"breadcrumb",props:{separator:{type:String,default:"/"},separatorIcon:{type:[Object,Function],default:null}},setup(s){const p=s;return P("breadcrumbSeparator",f(()=>p.separator)),P("breadcrumbSeparatorIcon",f(()=>p.separatorIcon)),(a,d)=>(l(),o("nav",N,[a.$slots.default?g(a.$slots,"default",{key:0}):m("",!0)]))}}),j={class:"my-breadcrumb-item"},E={key:1,class:"my-breadcrumb-link"},F={key:2,class:"my-breadcrumb-separator"},n=D({name:"MYBreadcrumb-item",__name:"breadcrumbItem",props:{to:{type:[String,Object],default:""},replace:{type:Boolean,default:!1}},setup(s){const p=s,a=_("breadcrumbSeparator","/"),d=_("breadcrumbSeparatorIcon",null),b=T(),u=!!b?.appContext.config.globalProperties.$router,I=f(()=>{const i=b?.parent?.subTree;if(!i)return!1;const k=Array.isArray(i.children)?i.children.filter(c=>typeof c=="object"&&c!==null&&"type"in c&&c.type?.name==="MYBreadcrumbItem"):[],h=k?.[k.length-1];return h&&typeof h=="object"&&"props"in h?h.props?.to===p.to&&b?.vnode===h:!1});return(i,k)=>(l(),o("span",j,[s.to?(l(),M(A(u?"router-link":"a"),{key:0,to:u?s.to:void 0,href:u?void 0:typeof s.to=="string"?s.to:s.to.path,replace:s.replace,class:"my-breadcrumb-link"},{default:e(()=>[i.$slots.default?g(i.$slots,"default",{key:0}):m("",!0)]),_:3},8,["to","href","replace"])):(l(),o("span",E,[i.$slots.default?g(i.$slots,"default",{key:0}):m("",!0)])),I.value?m("",!0):(l(),o("span",F,[y(d)?(l(),M(A(y(d)),{key:0})):(l(),o(S,{key:1},[r(v(y(a)),1)],64))]))]))}}),O=JSON.parse('{"title":"Breadcrumb","description":"","frontmatter":{},"headers":[],"relativePath":"components/NavigationBreadcrumb.md","filePath":"components/NavigationBreadcrumb.md"}'),$={name:"components/NavigationBreadcrumb.md"},w=Object.assign($,{setup(s){return(p,a)=>{const d=x("ShowCode");return l(),o("div",null,[a[8]||(a[8]=Y("",6)),t(d,{title:"代码演示",code:`
<template>
