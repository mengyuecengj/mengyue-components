import{u as B}from"./chunks/useStyleComputed.BVjmiXVX.js";import{d as S,o as p,c as k,O as c,k as A,n as v,r as g,G as D,H as C,b as _,I as P,ah as y,J as i,w as n,j as e,a as s,y as b}from"./chunks/framework.BzrxsKI0.js";import{_ as f}from"./chunks/button.vue_vue_type_script_setup_true_lang.BBsABRbJ.js";import"./chunks/useClassComputed.DNrZSa4y.js";import"./chunks/useColorUtils.BI8puWKr.js";const M={variant:{type:String,default:"text"},width:{type:[Number,String],default:"100%"},height:{type:[Number,String],default:16}},u=S({name:"MYSkeleton-item",__name:"skeletonItem",props:M,setup(m){const h=B(m,{propToStyleMap:{width:"width",height:"height"},customStyleLogic:(l,a)=>{l.variant==="text"?a.height=a.height==="auto"?"1.2em":a.height:l.variant==="circle"?(a.borderRadius="50%",a.height=a.width):l.variant==="image"?a.aspectRatio="1 / 1":l.variant==="rect"&&(a.borderRadius="4px")}});return(l,a)=>(p(),k("div",{class:v(["my-skeleton-item",`my-skeleton-item--${l.variant}`]),style:c(A(h))},null,6))}}),Y={loading:{type:Boolean,default:!0},animated:{type:Boolean,default:!0},count:{type:Number,default:3},randomWidth:{type:[Boolean,String],default:!1},throttle:{type:Number,default:0},theme:{type:String,default:"light"}},w={key:0,class:"my-skeleton__wrapper"},F={key:1,class:"my-skeleton__default"},T={key:1,class:"my-skeleton__content"},d=S({name:"MYSkeleton",__name:"skeleton",props:Y,setup(m){const r=m,h=[60,70,80,90,100],l=B(r,{cssVariables:{"--skeleton-bg":r.theme==="light"?"#f2f2f2":"#333","--skeleton-animation-bg":r.theme==="light"?"#e6e6e6":"#444","--skeleton-animation-speed":"1.5s"}});return(a,x)=>(p(),k("div",{class:v(["my-skeleton",{"my-skeleton--animated":a.animated}]),style:c(A(l))},[a.loading?(p(),k("div",w,[a.$slots.template?g(a.$slots,"template",{key:0},()=>[g(a.$slots,"template")]):(p(),k("div",F,[(p(!0),k(D,null,C(a.count,t=>(p(),_(u,{key:t,variant:"text",style:c({width:a.randomWidth?`${h[t%h.length]}%`:"100%"})},null,8,["style"]))),128))]))])):(p(),k("div",T,[g(a.$slots,"default")]))],6))}}),E={style:{display:"flex","flex-direction":"column",gap:"20px"}},I={style:{background:"#333",padding:"20px","border-radius":"4px"}},O=JSON.parse('{"title":"Skeleton","description":"","frontmatter":{},"headers":[],"relativePath":"components/FeedbackSkeleton.md","filePath":"components/FeedbackSkeleton.md"}'),N={name:"components/FeedbackSkeleton.md"},j=Object.assign(N,{setup(m){const r=b(!0),h=b(!1),l=()=>{r.value=!r.value},a=()=>{h.value=!0,setTimeout(()=>{h.value=!1},3e3)};return(x,t)=>{const o=P("ShowCode");return p(),k("div",null,[t[3]||(t[3]=y("",5)),i(o,{title:"代码演示",code:`
<template>
    <MYSkeleton />
</template>
...
<template>
  ...
  `.trim()},{demo:n(()=>[e("div",E,[i(d,{theme:"light"}),e("div",I,[i(d,{theme:"dark"})])])]),_:1},8,["code"]),t[18]||(t[18]=y("",9))])}}});export{O as __pageData,j as default};
