...
<\/script>`},{demo:t(()=>[a("div",R,[i(p,{columns:D.value,data:B.value,modelValue:o.value,"onUpdate:modelValue":s[0]||(s[0]=e=>o.value=e),onSelectionChange:A},null,8,["columns","data","modelValue"]),a("div",N," 已选择: "+y(o.value.map(e=>e.name).join(", ")),1)])]),_:1}),s[6]||(s[6]=a("h2",{id:"树形数据",tabindex:"-1"},[h("树形数据 "),a("a",{class:"header-anchor",href:"#树形数据","aria-label":"Permalink to “树形数据”"},"​"),a("span",{class:"pagefind-pinyin","aria-hidden":"true"},"shuxingshuju shu xing shu ju sxsj ")],-1)),i(l,{title:"树形数据",description:"使用树形结构数据展示层级关系",code:`<template>
  <MYTable 
    :columns='columns4' 
    :data='treeData' 
