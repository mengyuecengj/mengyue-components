...
<span class="line"><span></span></span></code></pre></div>`,7)),n("div",m,[t[1]||(t[1]=n("h3",null,"基础容器",-1)),a(r,{class:"basic-container"},{default:s(()=>t[0]||(t[0]=[n("p",null,"这是一个基础容器",-1)])),_:1,__:[0]})]),t[11]||(t[11]=d(`<h3 id="带着自定义样式的基础容器" tabindex="-1">带着自定义样式的基础容器 <a class="header-anchor" href="#带着自定义样式的基础容器" aria-label="Permalink to &quot;带着自定义样式的基础容器&quot;">​</a></h3><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki nord" style="color:#d8dee9ff;" tabindex="0"><code><span class="line"><span>&lt;div style=&quot;border: 1px solid #2c2; padding: 15px; border-radius: 4px&quot;&gt;</span></span>
...
<span class="line"><span>  tag?: string;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span></code></pre></div>`,13))])}const k=h(b,[["render",f]]);export{C as __pageData,k as default};
