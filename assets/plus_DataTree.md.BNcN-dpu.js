import{_ as b,a as i}from"./chunks/treeSelect.vue_vue_type_script_setup_true_lang.htKHRB31.js";import{I as f,o as v,c as x,a8 as s,J as d,w as r,j as e,a as n,A as o}from"./chunks/framework.DvHWw5tv.js";import"./chunks/checkbox-group.vue_vue_type_script_setup_true_lang.D38PW01g.js";import"./chunks/useStyleComputed.CediP0a2.js";const k={style:{"max-width":"600px"}},C=JSON.parse('{"title":"Tree 树形控件","description":"","frontmatter":{},"headers":[],"relativePath":"plus/DataTree.md","filePath":"plus/DataTree.md"}'),V={name:"plus/DataTree.md"},D=Object.assign(V,{setup(T){const h=o(null),m=o([]),c=o([2,4]),p=o(null),u=o(null);return(y,t)=>{const l=f("ShowCode");return v(),x("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776104037000"},[t[6]||(t[6]=s('<h1 id="tree-树形控件" tabindex="-1">Tree 树形控件 <a class="header-anchor" href="#tree-树形控件" aria-label="Permalink to “Tree 树形控件”">​</a></h1><h2 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-label="Permalink to “简介”">​</a></h2><p>树形控件用于展示层级结构数据，支持展开/收起、选中、复选等功能。可以用于组织架构、文件目录、分类等场景。</p><h2 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to “基础用法”">​</a></h2><p>基础的树形结构展示，支持节点点击事件。</p>',5)),d(l,{title:"基础用法",code:`
<template>
  <MYTree
    :data='treeData'
