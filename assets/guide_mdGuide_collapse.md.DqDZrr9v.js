...
<span class="line"><span></span></span></code></pre></div>`,6)),l(d,{modelValue:o.value,"onUpdate:modelValue":a[0]||(a[0]=e=>o.value=e)},{default:n(()=>[l(t,{title:"功能特性",name:"1"},{default:n(()=>[...a[2]||(a[2]=[s("div",null,"支持多面板同时展开",-1),s("div",null,"通过 v-model 绑定展开的面板",-1)])]),_:1}),l(t,{title:"用户体验",name:"2"},{default:n(()=>[...a[3]||(a[3]=[s("div",null,"提供平滑的展开/收起动画",-1),s("div",null,"支持自定义内容",-1)])]),_:1}),l(t,{title:"可配置性",name:"3"},{default:n(()=>[...a[4]||(a[4]=[s("div",null,"可以通过 props 调整行为",-1),s("div",null,"支持手风琴模式和多面板模式",-1)])]),_:1})]),_:1},8,["modelValue"]),a[9]||(a[9]=p(`<h2 id="手风琴模式" tabindex="-1">手风琴模式 <a class="header-anchor" href="#手风琴模式" aria-label="Permalink to &quot;手风琴模式&quot;">​</a></h2><p>使用<code>accordion</code>属性可以设置为手风琴模式，每次只能展开一个面板。</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki nord" style="color:#d8dee9ff;" tabindex="0"><code><span class="line"><span>&lt;MYCollapse v-model=&quot;activeAccordionName&quot; accordion&gt;</span></span>
...
<span class="line"><span style="color:#ECEFF4;">}</span><span style="color:#81A1C1;">;</span></span>
<span class="line"></span></code></pre></div>`,7))])}}});export{q as __pageData,y as default};
