import{_ as n}from"./chunks/input.vue_vue_type_script_setup_true_lang.DLgCXHxs.js";import{x as p,z as V,I as B,c as f,o as A,ah as x,J as s,j as e,w as r,a as t,R as w}from"./chunks/framework.BWIYv-lY.js";import"./chunks/useClassComputed.D3OyU7_1.js";import"./chunks/useStyleComputed.DYexXzp7.js";const U=JSON.parse('{"title":"Input","description":"","frontmatter":{},"headers":[],"relativePath":"components/FormInput.md","filePath":"components/FormInput.md"}'),D={name:"components/FormInput.md"},M=Object.assign(D,{setup(v){const o=p(""),h=p(""),k=p(""),m=p(""),u=p(""),g=p(""),b=p(""),c=p(""),y=p(""),i=()=>{w(()=>{})};return V([o,h,k,m,u,g,b,c,y],()=>{i()}),(C,a)=>{const d=B("ShowCode");return A(),f("div",null,[a[9]||(a[9]=x("",5)),s(d,{title:"代码演示",code:`
<template>
