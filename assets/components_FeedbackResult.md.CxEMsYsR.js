import{_ as l}from"./chunks/result.vue_vue_type_script_setup_true_lang.BToKtu14.js";import{_ as r}from"./chunks/button.vue_vue_type_script_setup_true_lang.DRTmpM5H.js";import{I as p,o,c as h,a8 as d,J as i,w as e,j as s,a}from"./chunks/framework.DvHWw5tv.js";import"./chunks/useClassComputed.B59PvPGn.js";import"./chunks/useColorUtils.Cv3Q488p.js";const k={style:{display:"flex","flex-direction":"column",gap:"20px"}},c={style:{display:"flex",gap:"10px","justify-content":"center"}},u={style:{display:"flex",gap:"10px","justify-content":"center"}},_=JSON.parse('{"title":"Result","description":"","frontmatter":{},"headers":[],"relativePath":"components/FeedbackResult.md","filePath":"components/FeedbackResult.md"}'),y={name:"components/FeedbackResult.md"},T=Object.assign(y,{setup(b){return(m,t)=>{const n=p("ShowCode");return o(),h("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776410922000"},[t[6]||(t[6]=d('<h1 id="result" tabindex="-1">Result <a class="header-anchor" href="#result" aria-label="Permalink to “Result”">​</a></h1><h2 id="简易介绍" tabindex="-1">简易介绍 <a class="header-anchor" href="#简易介绍" aria-label="Permalink to “简易介绍”">​</a></h2><p>result结果组件，用于展示操作结果的状态。<br> 可以使用<code>&lt;MYResult&gt;&lt;/MYResult&gt;</code>来实现一个结果展示。</p><h2 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to “基础用法”">​</a></h2><p>使用<code>title</code>属性设置主标题，<code>subTitle</code>属性设置副标题。</p>',5)),i(n,{title:"代码演示",code:`
<template>
...
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div>`,7))])}}});export{_ as __pageData,T as default};
