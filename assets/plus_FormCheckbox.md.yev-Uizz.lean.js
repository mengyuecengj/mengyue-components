import{a as l,_ as r}from"./chunks/checkbox-group.vue_vue_type_script_setup_true_lang.D38PW01g.js";import{y as v,I as M,o as Y,c as B,a8 as c,J as s,w as i,j as t,a,A as n,R as A}from"./chunks/framework.DvHWw5tv.js";const E=JSON.parse('{"title":"Checkbox","description":"","frontmatter":{},"headers":[],"relativePath":"plus/FormCheckbox.md","filePath":"plus/FormCheckbox.md"}'),V={name:"plus/FormCheckbox.md"},F=Object.assign(V,{setup(D){const h=n(!0),p=n(["option1"]),k=n([]),b=n(["red"]),g=n(["mon"]),u=n([]),m=n(["default"]),x=n(["option1"]),C=n(["1"]),y=n(["default"]),f=()=>{A(()=>{})};return v([h,p,k,b,g,u,m,x,C,y],()=>{f()}),(P,e)=>{const o=M("ShowCode");return Y(),B("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1776104037000"},[e[18]||(e[18]=c("",6)),s(o,{title:"代码演示",code:`
<template>
