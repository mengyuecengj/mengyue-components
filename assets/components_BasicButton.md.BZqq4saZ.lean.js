import{_ as n}from"./chunks/button.vue_vue_type_script_setup_true_lang.BBsABRbJ.js";import{_ as r}from"./chunks/a.vue_vue_type_script_setup_true_lang.D8TquksN.js";import{_ as u}from"./chunks/plus.vue_vue_type_script_setup_true_lang.CFonOHCX.js";import{I as o,o as k,c as h,ah as p,J as s,w as i,j as l,a}from"./chunks/framework.BzrxsKI0.js";import"./chunks/useClassComputed.DNrZSa4y.js";import"./chunks/useColorUtils.BI8puWKr.js";import"./chunks/useStyleComputed.BVjmiXVX.js";import"./chunks/IconBase.vue_vue_type_script_setup_true_lang.DoIAwF94.js";const g={style:{display:"grid","grid-template-columns":"repeat(auto-fit, minmax(200px, 1fr))",gap:"10px","justify-content":"center","margin-top":"20px"}},m={style:{display:"flex",gap:"50px"}},B={style:{display:"flex",gap:"50px"}},y={style:{display:"flex",gap:"50px"}},b={style:{display:"grid","grid-template-columns":"repeat(auto-fit, minmax(200px, 1fr))",gap:"10px","justify-content":"center","margin-top":"20px"}},c=JSON.parse('{"title":"Button","description":"","frontmatter":{},"headers":[],"relativePath":"components/BasicButton.md","filePath":"components/BasicButton.md"}'),f={name:"components/BasicButton.md"},S=Object.assign(f,{setup(M){return(Y,t)=>{const e=o("ClientOnly"),d=o("ShowCode");return k(),h("div",null,[t[37]||(t[37]=p("",6)),s(d,{title:"代码演示",code:`
<template>
