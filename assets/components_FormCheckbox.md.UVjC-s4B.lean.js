import{_ as l,a as r}from"./chunks/checkbox-group.vue_vue_type_script_setup_true_lang.BPJu8OyT.js";import{x as n,z as f,I as M,c as Y,o as B,ah as c,J as s,j as t,w as i,a,R as A}from"./chunks/framework.DHTvsukI.js";const E=JSON.parse('{"title":"Checkbox","description":"","frontmatter":{},"headers":[],"relativePath":"components/FormCheckbox.md","filePath":"components/FormCheckbox.md"}'),V={name:"components/FormCheckbox.md"},F=Object.assign(V,{setup(D){const h=n(!0),p=n(["option1"]),k=n([]),b=n(["red"]),m=n(["mon"]),u=n([]),g=n(["default"]),x=n(["option1"]),C=n(["1"]),y=n(["default"]),v=()=>{A(()=>{})};return f([h,p,k,b,m,u,g,x,C,y],()=>{v()}),(P,e)=>{const o=M("ShowCode");return B(),Y("div",null,[e[18]||(e[18]=c("",6)),s(o,{title:"代码演示",code:`
<template>
