...
<template>
  ...
  `.trim()},{demo:i(()=>[e(n,{type:"primary",onClick:s[18]||(s[18]=a=>k.value=!0)},{default:i(()=>[...s[44]||(s[44]=[l("组合使用",-1)])]),_:1}),e(d,{modelValue:k.value,"onUpdate:modelValue":s[21]||(s[21]=a=>k.value=a),title:"组合使用示例",width:"500px",height:"350px",backgroundColor:"#fff",borderColor:"#8d4dd1",textColor:"#333",closeOnClickModal:!1,closeOnPressEscape:!0,overflow:!1,onOpen:D,onClose:v},{footer:i(()=>[t("div",V,[e(n,{type:"info",onClick:s[19]||(s[19]=a=>k.value=!1)},{default:i(()=>[...s[45]||(s[45]=[l("取消",-1)])]),_:1}),e(n,{type:"primary",onClick:s[20]||(s[20]=a=>k.value=!1)},{default:i(()=>[...s[46]||(s[46]=[l("确认",-1)])]),_:1})])]),default:i(()=>[s[47]||(s[47]=t("p",{style:{color:"black"}},">这是一个组合使用的完整示例",-1)),s[48]||(s[48]=t("p",{style:{color:"black"}},">包含了所有可用的属性和功能",-1))]),_:1},8,["modelValue"])]),_:1},8,["code"]),s[66]||(s[66]=x("",9))])}}});export{j as __pageData,J as default};
