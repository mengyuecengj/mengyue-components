import{u as y}from"./chunks/useStyleComputed.DYexXzp7.js";import{d as g,c as h,o as f,O as b,k as m,j as t,r as o,I as k,ah as n,J as d,w as i,a as l}from"./chunks/framework.BWIYv-lY.js";const u={title:{type:String,default:""},width:{type:String,default:""},height:{type:String,default:""},footer:{type:String,default:""},backgroundColor:{type:String,default:""}},v={class:"my-card__header"},c={class:"my-card__body"},w={class:"my-card__footer"},a=g({name:"MYCard",__name:"card",props:u,emits:["close"],setup(p,{emit:x}){const s=y(p,{propToStyleMap:{backgroundColor:"backgroundColor",width:"width",height:"height"}});return(r,z)=>(f(),h("div",{class:"my-card",style:b(m(s))},[t("div",v,[o(r.$slots,"header")]),t("div",c,[o(r.$slots,"body")]),t("div",w,[o(r.$slots,"footer")])],4))}}),C={style:{"max-width":"400px"}},M={style:{display:"flex",gap:"20px","flex-wrap":"wrap"}},B={style:{display:"flex",gap:"20px","flex-wrap":"wrap"}},F={style:{display:"flex",gap:"20px","flex-wrap":"wrap"}},Y={style:{"max-width":"400px"}},P={style:{display:"flex",gap:"20px","flex-wrap":"wrap"}},S=JSON.parse('{"title":"Card","description":"","frontmatter":{},"headers":[],"relativePath":"components/OtherCard.md","filePath":"components/OtherCard.md"}'),A={name:"components/OtherCard.md"},T=Object.assign(A,{setup(p){return(x,e)=>{const s=k("ShowCode");return f(),h("div",null,[e[25]||(e[25]=n('<h1 id="card" tabindex="-1">Card <a class="header-anchor" href="#card" aria-label="Permalink to “Card”">​</a></h1><h2 id="简易介绍" tabindex="-1">简易介绍 <a class="header-anchor" href="#简易介绍" aria-label="Permalink to “简易介绍”">​</a></h2><p>Card 卡片组件，用于展示信息和内容块，支持自定义头部、主体和底部。mengyue-components 进行了封装并进行了 vitest 测试。 可以使用 <code>&lt;MYCard&gt;&lt;/MYCard&gt;</code> 或者 <code>&lt;MYCard /&gt;</code> 来实现卡片布局。</p><h2 id="基本用法" tabindex="-1">基本用法 <a class="header-anchor" href="#基本用法" aria-label="Permalink to “基本用法”">​</a></h2><h3 id="基础卡片" tabindex="-1">基础卡片 <a class="header-anchor" href="#基础卡片" aria-label="Permalink to “基础卡片”">​</a></h3><p>基础的卡片组件，包含头部、主体和底部。</p>',6)),d(s,{title:"代码演示",code:`
<template>
  <MYCard>
    <template #header>
...
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div>`,7))])}}});export{S as __pageData,T as default};
