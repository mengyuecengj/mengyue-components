...
<template>
  ...
  `.trim()},{demo:l(()=>[e(r,{modelValue:d.value,"onUpdate:modelValue":a[0]||(a[0]=i=>d.value=i)},{default:l(()=>[e(t,{title:"功能特性",name:"1"},{default:l(()=>[...a[2]||(a[2]=[s("div",null,"支持多面板同时展开",-1),s("div",null,"通过 v-model 绑定展开的面板",-1)])]),_:1}),e(t,{title:"用户体验",name:"2"},{default:l(()=>[...a[3]||(a[3]=[s("div",null,"提供平滑的展开/收起动画",-1),s("div",null,"支持自定义内容",-1)])]),_:1}),e(t,{title:"可配置性",name:"3"},{default:l(()=>[...a[4]||(a[4]=[s("div",null,"可以通过 props 调整行为",-1),s("div",null,"支持手风琴模式和多面板模式",-1)])]),_:1})]),_:1},8,["modelValue"])]),_:1},8,["code"]),a[9]||(a[9]=s("h2",{id:"手风琴模式",tabindex:"-1"},[n("手风琴模式 "),s("a",{class:"header-anchor",href:"#手风琴模式","aria-label":"Permalink to “手风琴模式”"},"​")],-1)),a[10]||(a[10]=s("p",null,[n("使用"),s("code",null,"accordion"),n("属性可以设置为手风琴模式，每次只能展开一个面板。")],-1)),e(o,{title:"代码演示",code:`
<template>
