...
## Brief Introduction
The Container component is used to wrap other content and provide layout and style control.
There are five tags available:
...
`<MYFooter></MYFooter>` and `<MYFooter />`: Footer<br />
...
| background  | Background color               | string       | Hex or named color                   | —       |
...
| width       | Width                          | string/number| px/em/rem/dynamic/%                   | —        |
| background  | Background color               | string       | Hex or named color                   | —        |
| fixed       | Fixed header navigation        | boolean      | —                                    | `false`  |
| tag         | Container tag                  | string       | Any HTML tag                         | `header` |
...
| tag         | Container tag                  | string       | Any HTML tag                         | `aside`  |
...
| width       | Width                          | string/number| px/em/rem/dynamic/%                   | —       |
| background  | Background color               | string       | Hex or named color                   | —       |
| tag         | Container tag                  | string       | Any HTML tag                         | `main`  |
...
| width       | Width                          | string/number| px/em/rem/dynamic/%                   | —        |
| background  | Background color               | string       | Hex or named color                   | —        |
| tag         | Container tag                  | string       | Any HTML tag                         | `footer` |
