...
<MYBorder Border="2px solid #8a8e96ff" height="100px" center paddingText="10px">
    <MYRow :gutter="16" style="margin-bottom: 20px">
        <MYCol :span="8">
            <MYButton>Default按钮</MYButton>
        </MYCol>
        <MYCol :span="8">
...
当然也支持下面这种方式来自定义文字颜色
```vue
<MYButton colorBorder="coral">自定义珊瑚色背景按钮</MYButton>
```
<MYButton colorBorder="coral">自定义珊瑚色背景按钮</MYButton>
...
```
运行后的效果
<MYBorder Border="2px solid #8a8e96ff" height="200px" center paddingText="10px">
    <MYRow :gutter="16">
        <MYCol :span="6">
            <MYButton size="supersmall">supersmall按钮</MYButton>
        </MYCol>
...
| colorText  | 文字颜色     | string  | 支持16进制颜色或单词颜色                 | —      |
| colorBorder| 边框颜色     | string  | 支持16进制颜色或单词颜色               | —      |
| tag    | 渲染标签      | string  | 支持所有 HTML 标签                 | `button` |
